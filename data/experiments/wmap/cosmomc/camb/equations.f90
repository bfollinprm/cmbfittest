...
!        print*, CP%Num_Nu_massless, CP%Num_Nu_massive
!        print*, grhok, grhoc, grhob, grhog, grhornomass
!        pause
!  8*pi*G*rho*a**4.
...
!The rest, note y(9)->octg, yprime(9)->octgprime (octopoles)
    ...
    if (1.00/a-1.00 .lt. 30.00) then
        ISW_term = ISW
    else
        ISW_term = ISW * CP%aeisw
    endif
    
    sources(1)= ISW_term +  ((-9.D0/160.D0*pig-27.D0/80.D0*ypol(2))/k**2*opac(j)+(11.D0/10.D0*sigma- &
