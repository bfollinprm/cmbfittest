...
! Main parameters type
        type CAMBparams
         ...
         real(dl)  :: aeisw = 1.00_dl
         real(dl)  :: alens = 1.00_dl
...
! accuracy (numerical integration precision) better than 1.e-5.
        ...
        call Recombination_Init(CP%Recomb, CP%omegac, CP%omegab,CP%Omegan, CP%Omegav, CP%h0,CP%tcmb,CP%yhe,CP%Num_Nu_massless)
