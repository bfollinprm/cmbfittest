...
!                    (e.g. beam uncertainty modes, etc, specific to dataset)
  ...
  integer, parameter :: num_freq_params = 4
  integer, parameter :: num_norm = 4 + num_freq_params  !! Increment num_norm by 2 - spt.lps12
                                                        !! (from 2 to 4 for the Jan 2010 version)
...
!The rest are set up automatically
  ...
  LOGICAL :: Use_SNLS = .FALSE.  !! Add Use_SNLS variable - spt.lps12
